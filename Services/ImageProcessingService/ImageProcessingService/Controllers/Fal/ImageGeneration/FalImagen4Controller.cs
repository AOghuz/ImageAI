...
[Route("api/fal/imagen4")]
[ApiController, Authorize]
public sealed class FalImagen4Controller : FalControllerBase
{
    private readonly IFalJobsService _svc;
    private readonly ILogger<FalImagen4Controller> _log;
    private const string ModelKey = "imagen4";

    public FalImagen4Controller(IFalJobsService svc, ILogger<FalImagen4Controller> log)
    { _svc = svc; _log = log; }

    public sealed class Imagen4Form
    {
    ...
    public async Task<IActionResult> TextToImage([FromForm] Imagen4Form form)
    {
