...
namespace ImageProcessingService.Services.Fal.Adapters.ImageGeneration.FluxKontextLora;

public sealed class FluxKontextLoraAdapter : FalModelAdapterBase
{
    public override string Key => "flux-kontext-lora";

    public override bool SupportsTextToImage => true;
    public override bool SupportsImageEdit => false;

    // Text-to-Image endpoint
    public override string GetTextToImagePath(FalModelConfig cfg) => cfg.ModelPath! + "/text-to-image";
    ...
    public override object BuildImageEditPayload(ImageEditRequest req, FalModelConfig cfg) =>
        throw new NotSupportedException("FluxKontextLora sadece text-to-image destekler.");
