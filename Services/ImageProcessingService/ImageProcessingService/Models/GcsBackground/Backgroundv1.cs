...
{
    public class Backgroundv1 : IBackgroundService
    {
        private readonly HttpClient _httpClient;
        private readonly IWebHostEnvironment _webHostEnvironment;
        private const string CloudRunUrl = "https://bg-remover-847860519762.europe-west4.run.app/remove-bg"; // Google Cloud Run API URL

        public Backgroundv1(HttpClient httpClient, IWebHostEnvironment webHostEnvironment)
        {
