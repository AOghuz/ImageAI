...
{
    public class Backgroundv3 : IBackgroundService
    {
        private readonly HttpClient _httpClient;
        private readonly IWebHostEnvironment _webHostEnvironment;
        private const string CloudRunUrl = "https://bg-remover-1098105917365.europe-west4.run.app/remove-bg"; // Google Cloud Run API URL

        public Backgroundv3(HttpClient httpClient, IWebHostEnvironment webHostEnvironment)
        {
